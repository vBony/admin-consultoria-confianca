...
<head>
  ...
  <link rel="stylesheet" href="<?=$baseUrl?>app/assets/css/esqueci-senha.css">
</head>
...
<div class="register-box">
  <div class="card card-outline card-primary">
	...
	<form method="post" id="regForm">
        ...
        <div class="input-group">
          <input type="password" name="retypePassword" class="form-control" placeholder="Repita a senha">
          <div class="input-group-append">
            <div class="input-group-text">
              <span class="fas fa-lock"></span>
            </div>
        ...
        <div class="row">
            <div class="col-12">
                <button type="submit" class="btn btn-primary btn-block" id="btn-register">Alterar senha</button>
